...
Cute.AbstractControl.prototype = {
	...
	__effEnd: function(e) {
		...
		if (this.ap) this.slider.setAutoPlay(false)
	},
...
Cute.Slider.prototype = {
		...
		if (this.element.getAttribute("data-overpause") != "false" && !Cute.FallBack.isMobileDevice) {
			...
			var i = function() {
				if (!Cute.AbstractControl.paused) {
					...
					this.slideManager.setAutoPlay(false)//true
				}
			};
	...
	__effEnd: function(e) {
		if (this.ap) this.slideManager.setAutoPlay(false)//true
	},
	...
	play: function() {
		Cute.AbstractControl.paused = false;
		this.api.setAutoPlay(false)//true
	},
	pause: function() {
		Cute.AbstractControl.paused = true;
